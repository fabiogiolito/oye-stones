<script>
  ...
  const palette = ['#B96A65', '#D1C1E3', '#9B4C47', '#A999BB', '#D8BFE8', '#DBCBED', '#D78883'];

  const stoneOptions = [
    {
      image: "/v1/stones_1_shade.png",
      shapes: [
